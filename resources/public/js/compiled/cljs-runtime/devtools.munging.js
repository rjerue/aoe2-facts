...
var o45755 = temp__5733__auto__;
var temp__5733__auto____$1 = (o45755["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o45756 = temp__5733__auto____$1;
return (o45756["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__45022__auto__ = f;
return (o__45022__auto__["toString"]).call(o__45022__auto__);
} else {
return "";
}
...
try{var o__45022__auto___46041 = t;
(o__45022__auto___46041["cljs$lang$ctorPrWriter"]).call(o__45022__auto___46041,t,writer);
}catch (e45770){var __46043 = e45770;
}
...
var char_code = (function (){var o__45022__auto__ = (new String(char$));
return (o__45022__auto__["charCodeAt"]).call(o__45022__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__45022__auto__ = String;
return (o__45022__auto__["fromCharCode"]).call(o__45022__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__45782 = num_code;
switch (G__45782) {
case (1):
return (185);
...
var o__45022__auto__ = String;
return (o__45022__auto__["fromCharCode"]).call(o__45022__auto__,superscript_code);
});
/**
...
}catch (e45799){var _e__45060__auto__ = e45799;
return false;
}})())){
...
var vec__45800 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45800,(0),null);
...
var len__4736__auto___46058 = arguments.length;
var i__4737__auto___46060 = (0);
while(true){
if((i__4737__auto___46060 < len__4736__auto___46058)){
args__4742__auto__.push((arguments[i__4737__auto___46060]));

var G__46063 = (i__4737__auto___46060 + (1));
i__4737__auto___46060 = G__46063;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__45825){
var vec__45826 = p__45825;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45826,(0),null);
...
var G__46068 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__46069 = cljs.core.butlast(remaining_tokens);
name_tokens = G__46068;
remaining_tokens = G__46069;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq45821){
...
var vec__45869 = cljs.core.split_with((function (p1__45854_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__45854_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45869,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45869,(1),null);
...
var vec__45881 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45881,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45881,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__46072 = cljs.core.rest(remaining_tokens);
var G__46073 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__46072;
name_tokens = G__46073;
continue;
} else {
...
var vec__45892 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45892,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45892,(1),null);
var vec__45895 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45895,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45895,(1),null);
var vec__45898 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45898,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45898,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45898,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45898,(3),null);
...
var vec__45909 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45909,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45909,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45909,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45909,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45909,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45909,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__45913 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45913,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45913,(1),null);
var vec__45916 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45916,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45916,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__45922 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__45922) : devtools.munging.parse_fn_info_deep.call(null,G__45922));
})()));
}
} else {
return fn_info;
...
var G__46097 = (arity + (1));
var G__46098 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__45938){
var vec__45939 = p__45938;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45939,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45939,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45945_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__45945_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45949_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__45949_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___46104 = arguments.length;
var i__4737__auto___46105 = (0);
while(true){
if((i__4737__auto___46105 < len__4736__auto___46104)){
args__4742__auto__.push((arguments[i__4737__auto___46105]));

var G__46106 = (i__4737__auto___46105 + (1));
i__4737__auto___46105 = G__46106;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__45955){
var vec__45956 = p__45955;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45956,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq45952){
var G__45953 = cljs.core.first(seq45952);
var seq45952__$1 = cljs.core.next(seq45952);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45953,seq45952__$1);
}));
...
var G__45961 = arg;
var G__45961__$1 = (((G__45961 instanceof cljs.core.Keyword))?G__45961.fqn:null);
switch (G__45961__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45978__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45978__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45978__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45978__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__45979 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45979,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45979,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45979,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45979,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45979,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45979,(5),null);
...
var o__45022__auto__ = f;
return (o__45022__auto__["getBasis"]).call(o__45022__auto__);
});
/**
...
}catch (e45990){var _e__45060__auto__ = e45990;
...
var G__46120 = (obj[cljs.core.first(path)]);
var G__46121 = cljs.core.rest(path);
obj = G__46120;
path = G__46121;
continue;
} else {
...
var _STAR_ = (function (accum,p__46008){
var vec__46010 = p__46008;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46010,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46010,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__46015){
...
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46016,(2),null);
...
var post_process = (function (p__46026){
var vec__46027 = p__46026;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46027,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46027,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46024_SHARP_){
return (obj[cljs.core.first(p1__46024_SHARP_)]);
}),sorted_matches);
