...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__46166){
...
var request = map__46167__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46167__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__46172 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__46172.cljs$core$IFn$_invoke$arity$1 ? fexpr__46172.cljs$core$IFn$_invoke$arity$1(response) : fexpr__46172.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__46173 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__46173.cljs$core$IFn$_invoke$arity$1 ? fexpr__46173.cljs$core$IFn$_invoke$arity$1(response) : fexpr__46173.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__46174){
...
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46175__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
