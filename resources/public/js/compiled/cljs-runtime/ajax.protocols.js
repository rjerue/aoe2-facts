...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_45832 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_45832(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_45838 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_45838(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_45844 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_45844(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_45856 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_45856(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_45867 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_45867(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_45873 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_45873(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_45886 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_45886(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_45905 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_45905(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_45914 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_45914(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_45923 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_45923(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k45819,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45819,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__45824){
var vec__45825 = p__45824;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45825,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45825,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45818){
var self__ = this;
var G__45818__$1 = this;
return (new cljs.core.RecordIter((0),G__45818__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45820,other45821){
var self__ = this;
var this45820__$1 = this;
return (((!((other45821 == null)))) && ((this45820__$1.constructor === other45821.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45820__$1.status,other45821.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45820__$1.body,other45821.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45820__$1.status_text,other45821.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45820__$1.headers,other45821.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45820__$1.was_aborted,other45821.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45820__$1.__extmap,other45821.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__45818){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__45828 = cljs.core.keyword_identical_QMARK_;
var expr__45829 = k__4388__auto__;
if(cljs.core.truth_((pred__45828.cljs$core$IFn$_invoke$arity$2 ? pred__45828.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__45829) : pred__45828.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__45829)))){
return (new ajax.protocols.Response(G__45818,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45828.cljs$core$IFn$_invoke$arity$2 ? pred__45828.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__45829) : pred__45828.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__45829)))){
return (new ajax.protocols.Response(self__.status,G__45818,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45828.cljs$core$IFn$_invoke$arity$2 ? pred__45828.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__45829) : pred__45828.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__45829)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__45818,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45828.cljs$core$IFn$_invoke$arity$2 ? pred__45828.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__45829) : pred__45828.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__45829)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__45818,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45828.cljs$core$IFn$_invoke$arity$2 ? pred__45828.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__45829) : pred__45828.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__45829)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__45818,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__45818),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__45818){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__45818,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__45822){
var extmap__4419__auto__ = (function (){var G__45831 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__45822,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__45822)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__45831);
} else {
return G__45831;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__45822),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__45822),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__45822),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__45822),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__45822),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
