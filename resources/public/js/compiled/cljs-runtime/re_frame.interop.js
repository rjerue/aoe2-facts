...
return [(function (){var pred__54532 = cljs.core.instance_QMARK_;
var expr__54533 = reactive_val;
if(cljs.core.truth_((pred__54532.cljs$core$IFn$_invoke$arity$2 ? pred__54532.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__54533) : pred__54532.call(null,reagent.ratom.RAtom,expr__54533)))){
return "ra";
} else {
if(cljs.core.truth_((pred__54532.cljs$core$IFn$_invoke$arity$2 ? pred__54532.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__54533) : pred__54532.call(null,reagent.ratom.RCursor,expr__54533)))){
return "rc";
} else {
if(cljs.core.truth_((pred__54532.cljs$core$IFn$_invoke$arity$2 ? pred__54532.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__54533) : pred__54532.call(null,reagent.ratom.Reaction,expr__54533)))){
return "rx";
} else {
if(cljs.core.truth_((pred__54532.cljs$core$IFn$_invoke$arity$2 ? pred__54532.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__54533) : pred__54532.call(null,reagent.ratom.Track,expr__54533)))){
return "tr";
} else {
return "other";
}
