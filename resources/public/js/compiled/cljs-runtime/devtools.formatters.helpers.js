...
var G__46102 = devtools.prefs.pref(v);
v = G__46102;
continue;
} else {
return v;
...
}catch (e46053){var _e__45060__auto__ = e46053;
return false;
}})();
...
}catch (e46064){var _e__45060__auto__ = e46064;
return false;
}})();
...
}catch (e46066){var _e__45060__auto__ = e46066;
return false;
}}
}
});
...
var vec__46083 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46083,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46083,(1),null);
...
return cljs.core.some((function (p1__46093_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__46093_SHARP_);
}),template);
});
