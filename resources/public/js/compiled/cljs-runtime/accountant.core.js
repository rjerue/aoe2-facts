...
if(cljs.core.truth_(((cljs.core.not(any_key))?(function (){var and__4115__auto__ = (function (){var fexpr__45876 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__45876.cljs$core$IFn$_invoke$arity$1 ? fexpr__45876.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__45876.call(null,link_target));
})();
if(cljs.core.truth_(and__4115__auto__)){
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__45877){
...
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45878__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45878__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45878__$1,new cljs.core.Keyword(null,"reload-same-path?","reload-same-path?",1981904231));
...
var seq__45880 = cljs.core.seq(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [accountant.core.document_click_handler_listener_key,accountant.core.navigate_listener_key], null));
var chunk__45881 = null;
var count__45882 = (0);
var i__45883 = (0);
while(true){
if((i__45883 < count__45882)){
var key = chunk__45881.cljs$core$IIndexed$_nth$arity$2(null,i__45883);
...
var G__45892 = seq__45880;
var G__45893 = chunk__45881;
var G__45894 = count__45882;
var G__45895 = (i__45883 + (1));
seq__45880 = G__45892;
chunk__45881 = G__45893;
count__45882 = G__45894;
i__45883 = G__45895;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__45880);
if(temp__5735__auto__){
var seq__45880__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__45880__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__45880__$1);
var G__45897 = cljs.core.chunk_rest(seq__45880__$1);
var G__45898 = c__4556__auto__;
var G__45899 = cljs.core.count(c__4556__auto__);
var G__45900 = (0);
seq__45880 = G__45897;
chunk__45881 = G__45898;
count__45882 = G__45899;
i__45883 = G__45900;
continue;
} else {
var key = cljs.core.first(seq__45880__$1);
if(cljs.core.truth_(key)){
goog.events.unlistenByKey(key);
} else {
}
...
var G__45901 = cljs.core.next(seq__45880__$1);
var G__45902 = null;
var G__45903 = (0);
var G__45904 = (0);
seq__45880 = G__45901;
chunk__45881 = G__45902;
count__45882 = G__45903;
i__45883 = G__45904;
continue;
}
} else {
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45884_SHARP_){
return cljs.core.name(p1__45884_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45885_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__45885_SHARP_);
}),pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__45888 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__45888) : accountant.core.nav_handler.call(null,G__45888));
} else {
