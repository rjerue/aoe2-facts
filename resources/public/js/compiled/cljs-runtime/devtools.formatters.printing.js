...
var i__4737__auto___46146 = (0);
while(true){
if((i__4737__auto___46146 < len__4736__auto___46145)){
args__4742__auto__.push((arguments[i__4737__auto___46146]));

var G__46147 = (i__4737__auto___46146 + (1));
i__4737__auto___46146 = G__46147;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq46109){
var G__46110 = cljs.core.first(seq46109);
var seq46109__$1 = cljs.core.next(seq46109);
var G__46111 = cljs.core.first(seq46109__$1);
var seq46109__$2 = cljs.core.next(seq46109__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46110,G__46111,seq46109__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__46126_SHARP_){
return (!((cljs.core.meta(p1__46126_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46127__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e46131){var _e__45060__auto__ = e46131;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e46133){var _e__45060__auto__ = e46133;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__46135 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__46136 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__46136);

try{var map__46137 = opts;
var map__46137__$1 = (((((!((map__46137 == null))))?(((((map__46137.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46137.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__46137):map__46137);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46137__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__46135);
}});
...
var temp__5733__auto___46166 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___46166)){
var managed_print_level_46167 = temp__5733__auto___46166;
var _STAR_print_level_STAR__orig_val__46141_46168 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__46142_46169 = managed_print_level_46167;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__46142_46169);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__46140_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__46140_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__46141_46168);
}} else {
job_fn();
}
