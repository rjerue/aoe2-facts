...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_47724 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_47724(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_47728 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_47728(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_47731 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_47731(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_47736 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_47736(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_47737 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_47737(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_47747 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_47747(reader);
}
});
...
var G__47841 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__47842 = s.append(c);
c = G__47841;
s = G__47842;
continue;
}
