...
if((i < len)){
var k = (ks[i]);
var G__53893 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__53894 = (i + (1));
m = G__53893;
i = G__53894;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__53683 = c;
var G__53683__$1 = (((G__53683 == null))?null:G__53683.prototype);
if((G__53683__$1 == null)){
return null;
} else {
return G__53683__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__53699 = c;
var G__53699__$1 = (((G__53699 == null))?null:G__53699.prototype);
if((G__53699__$1 == null)){
return null;
} else {
return G__53699__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__53915__delegate = function (args){
var G__53731 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__53731) : reagent.impl.component.as_element.call(null,G__53731));
};
var G__53915 = function (var_args){
var args = null;
...
while (G__53917__i < G__53917__a.length) {G__53917__a[G__53917__i] = arguments[G__53917__i + 0]; ++G__53917__i;}
  args = new cljs.core.IndexedSeq(G__53917__a,0,null);
} 
return G__53915__delegate.call(this,args);};
G__53915.cljs$lang$maxFixedArity = 0;
G__53915.cljs$lang$applyTo = (function (arglist__53919){
var args = cljs.core.seq(arglist__53919);
return G__53915__delegate(args);
});
G__53915.cljs$core$IFn$_invoke$arity$variadic = G__53915__delegate;
return G__53915;
})()
;})(c,f,_,res))
:res);
...
var G__53734 = c;
var G__53734__$1 = (((G__53734 == null))?null:G__53734.constructor);
if((G__53734__$1 == null)){
return null;
} else {
return G__53734__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__53740 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__53741 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__53741);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__53740);
}});
...
var c = this;
var G__53779_53952 = goog.object.get(c,"cljsRatom");
if((G__53779_53952 == null)){
} else {
reagent.ratom.dispose_BANG_(G__53779_53952);
}
...
var renders_53957 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_53958 = cljs.core.first(cljs.core.vals(renders_53957));
...
if((cljs.core.count(renders_53957) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_53957))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_53958)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_53958], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__53808 = o;
goog.object.set(G__53808,cljs.core.name(k),v);
