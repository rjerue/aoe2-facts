...
Facts abotu AOE2. Uses cors anywhere so don't get too excited with http requests.
...
* [`src/cljs/aoe2/`](src/cljs/aoe2/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/aoe2/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `aoe2` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/aoe2/config.cljs) defaults to `true` in
